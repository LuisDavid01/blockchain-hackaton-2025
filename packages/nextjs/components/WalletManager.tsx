      ...
      <div className="card w-full max-w-2xl bg-base-100 shadow-xl mx-auto">
        <div className="card-body">
          ...
          <div className="alert alert-warning">
            ...
            <div>
              ...
              <div className="text-sm">
                This seed phrase is the ONLY way to recover your wallet. Store it securely offline.
              </div>
            </div>
          </div>

          <div className="bg-base-200 p-6 rounded-lg my-4">
            <pre className="text-center text-lg font-mono whitespace-pre-wrap break-words">{newSeedPhrase}</pre>
          </div>
          ...
          <div className="card-actions justify-end mt-4">
            <button className="btn btn-primary" onClick={handleSeedSaved} disabled={!seedSaved}>
              Continue
            </button>
          </div>
        </div>
      ...
      <div className="card w-full max-w-lg bg-base-100 shadow-xl mx-auto">
        <div className="card-body p-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 mt-6">
            <button className="btn btn-outline btn-lg flex-1" onClick={() => setView("create")}>
              Create New Wallet
            </button>
            <button
    ...
    return (
      <div className="card w-full max-w-md bg-base-100 shadow-xl mx-auto">
        <div className="card-body items-center text-center">
          ...
          <p className="text-base-content/70">Network: {currentNetwork.displayName}</p>
          {error && (
          ...
          <div className="card-actions mt-4">
            <button className="btn btn-primary" onClick={handleUnlock} disabled={isLoading}>
      ...
      <div className="card w-full max-w-md bg-base-100 shadow-xl mx-auto">
        <div className="card-body items-center text-center">
          ...
          <div className="card-actions flex-col w-full gap-3">
            <button className="btn btn-primary w-full" onClick={handleCreateWallet} disabled={isLoading}>
    ...
    <div className="card w-full max-w-2xl bg-base-100 shadow-xl mx-auto">
      <div className="card-body">
        ...
        <div className="form-control w-full mt-4">
          ...
          <div className="flex items-center gap-2">{address && <Address address={address as `0x${string}`} />}</div>
        </div>
        ...
        <div className="form-control w-full mt-2">
          ...
          <div className="text-2xl font-bold">{address && <Balance address={address as `0x${string}`} />}</div>
        </div>
        ...
        <div className="card-actions justify-end mt-6 gap-2">
          ...
          <button className="btn btn-sm btn-warning" onClick={handleLock}>
            Lock Wallet
          </button>
          <button className="btn btn-sm btn-error" onClick={() => setShowDisconnectModal(true)}>
            Disconnect
          </button>
        </div>
      </div>
            ...
            {!exportedSeed ? (
              <>
                ...
                <div className="modal-action">
                  ...
                  <button className="btn btn-warning" onClick={handleExportSeed}>
                    Show Seed Phrase
                  </button>
                </div>
              </>
              ...
              <>
                <div className="bg-base-200 p-4 rounded-lg my-4">
                  <pre className="text-sm font-mono whitespace-pre-wrap break-words">{exportedSeed}</pre>
                </div>
      ...
      {showDisconnectModal && (
        <dialog className="modal modal-open">
          <div className="modal-box">
            ...
            <div className="modal-action">
              <button className="btn btn-ghost" onClick={() => setShowDisconnectModal(false)}>
                Cancel
              </button>
