...
<div className="min-h-screen text-foreground">
  {/* Hero Section */}
  <section className="relative bg-background py-20 px-5">
    <div className="max-w-6xl mx-auto text-center">
      ...
      {/* Wallet Connection */}
      <div className="bg-card rounded-2xl p-6 max-w-md mx-auto mb-12 animate-fade-in">
        {isInitialized && address ? (
          <div className="text-center">
            <p className="text-accent mb-2">✓ Conectado</p>
          ...
          <div className="text-center">
            ...
            <Link href="/wallet">
              <Button className="bg-primary hover:bg-primary/90 px-8 py-3 rounded-lg transform hover:scale-105 transition-all">
                Conectar Wallet
              </Button>
            </Link>
          </div>
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {services.map((service, index) => (
          <div
            key={index}
            className="bg-card p-6 rounded-xl hover:bg-accent transition-all duration-300 hover:transform hover:scale-105 group border border-border"
          >
            ...
            <div className="flex items-center mb-4">
              <service.icon className="h-10 w-10 text-primary mr-4 group-hover:scale-110 transition-transform" />
    ...
    <div className="max-w-6xl mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="animate-fade-in-right">
          <div className="bg-card p-8 rounded-2xl border border-border bg-gradient-to-br from-card to-card/50">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                <ChartBarIcon className="h-6 w-6 text-accent mr-3" />
                <div>
    ...
    <div className="max-w-4xl mx-auto text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <Link href="/publish">
          <Button
            variant="outline"
            className="border-border hover:bg-foreground hover:text-background px-8 py-3 rounded-lg transform hover:scale-105 transition-all"
          >
            Publicar Servicio
          </Button>
        </Link>
